    ...
    return (
        <div className="min-h-screen bg-white">
            <div className="container mx-auto px-6 py-12">
                ...
                <button
                    onClick={onBack}
                    className="flex items-center gap-2 text-primary font-black uppercase text-xs tracking-widest hover:gap-4 transition-all mb-12"
                >
                    ← Volver a Oferta
                </button>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="text-center mb-20 animate-fade-in">
                        <span className="text-gold font-black tracking-[0.4em] uppercase text-[11px] mb-4 block">Detalle Académico</span>
                    ...
                    <section className="mb-24 animate-slide-up">
                        <div className="flex items-center gap-4 mb-10 pb-6 border-b-2 border-primary/10">
                        ...
                        <div className="space-y-4">
                            {levelData.requirements.map((req, idx) => (
                                <div key={idx} className="border-b border-gray-100 last:border-0">
                                    ...
                                    >
                                        <span className={`text-[13px] md:text-lg font-black uppercase tracking-widest transition-colors ${openRequirement === idx ? 'text-primary' : 'text-gray-700 group-hover:text-primary'}`}>
                                            {req.title}
                                        </span>
                                    ...
                                    <div className={`overflow-hidden transition-all duration-700 ease-[cubic-bezier(0.85,0,0.15,1)] ${openRequirement === idx ? 'max-h-[1000px] pb-8 opacity-100' : 'max-h-0 opacity-0'}`}>
                                        <div className="p-8 bg-secondary/30 rounded-[2rem] border border-gray-50">
                                            <p className="text-gray-600 text-sm md:text-base leading-relaxed font-medium whitespace-pre-line">
                                                {req.content}
                                            </p>
                                        </div>
                                    </div>
                    ...
                    {/* Subjects Section */}
                    <section className="mb-24 animate-slide-up [animation-delay:200ms]">
                        <div className="flex items-center gap-4 mb-10 pb-6 border-b-2 border-primary/10">
                        ...
                        <div className="flex flex-wrap gap-4">
                            {levelData.subjects.map((subject, idx) => (
                                <div
                                    key={idx}
                                    className={`px-6 py-3 rounded-full flex items-center gap-3 transition-all hover:scale-105 shadow-sm border border-black/5`}
                                    style={{ backgroundColor: subject.color }}
                                >
                                    <span className="text-lg md:text-xl">{subject.icon}</span>
                                    <span className="font-black uppercase text-[10px] md:text-xs tracking-widest text-gray-800">
                                        {subject.name}
                                    </span>
                                </div>
                            ))}
                        ...
                        <div className="bg-footer-blue p-8 md:p-12 rounded-[3rem] shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
                                ...
                                <div className="bg-white/10 backdrop-blur-md p-8 rounded-3xl border border-white/20 text-center">
                                    ...
                                    <p className="text-white/60 text-[10px] font-black uppercase tracking-[0.3em]">Ambiente Familiar</p>
